# Observatory Pro -- v2.5.11

**Available since v1.3.0, current in v2.5.11** -- Six major upgrades that turn the Training Observatory from a passive log dump into an **active diagnostic engine**.
